...
def process_packet(packet):
    ...
    # print(scapy_packet)
    # print(scapy_packet.haslayer(DNSRR))
    # print("Got the packet")
    scapy_packet = IP(packet.get_payload())
    # print(scapy_packet.summary(), scapy_packet.haslayer(DNSRR), scapy_packet.haslayer(DNSQR)) 
    # print(scapy_packet[DNS].qd.qname)
